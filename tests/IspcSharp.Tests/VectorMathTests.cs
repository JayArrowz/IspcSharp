...
public class VectorMathTests
{
    ...
    {
        var x = Range(0.5f, 1.5f, VFloat.LaneCount);
        var result = VectorMath.Sqrt(x);
    ...
    {
        var x = Range(-4f, 1f, VFloat.LaneCount);
        var result = VectorMath.Abs(x);
    ...
    {
        var a = Range(1f, 1f, VFloat.LaneCount);
        var b = Range(10f, -1f, VFloat.LaneCount);

        var min = VectorMath.Min(a, b);
        var max = VectorMath.Max(a, b);
    ...
    {
        var x = Range(-2f, 1f, VFloat.LaneCount);
        var lo = new VFloat(0f);
        var hi = new VFloat(1f);

        var result = VectorMath.Clamp(x, lo, hi);
    ...
    {
        var a = Range(0f, 1f, VFloat.LaneCount);
        var b = Range(10f, 1f, VFloat.LaneCount);
        var t = new VFloat(0.5f);

        var result = VectorMath.Lerp(a, b, t);
    ...
    {
        var x = Range(-3f, 0.5f, VFloat.LaneCount);
        var result = VectorMath.Exp(x);
    ...
    {
        var x = Range(0.1f, 1f, VFloat.LaneCount);
        var result = VectorMath.Log(x);
    ...
    {
        var x = Range(-1f, 0.2f, VFloat.LaneCount);
        var result = VectorMath.Tan(x);
    ...
    {
        var x = Range(-4f, 1f, VFloat.LaneCount);
        var result = VectorMath.Sigmoid(x);
    ...
    {
        var x = Range(0.5f, 0.5f, VFloat.LaneCount);
        var y = new VFloat(2.5f);
        var result = VectorMath.Pow(x, y);
    ...
    {
        var x = Range(-3.7f, 0.9f, VFloat.LaneCount);
        var result = VectorMath.Floor(x);
    ...
    {
        var x = Range(-3.4f, 0.8f, VFloat.LaneCount);
        var result = VectorMath.Round(x);
    ...
    {
        var x = Range(1f, 1f, VFloat.LaneCount);
        var result = VectorMath.Rcp(x);
    ...
    {
        var x = Range(0.5f, 1f, VFloat.LaneCount);
        var result = VectorMath.Rsqrt(x);
    ...
    {
        var a = Range(1f, 1f, VFloat.LaneCount);
        var b = Range(2f, 1f, VFloat.LaneCount);
        var c = Range(0.5f, 0.5f, VFloat.LaneCount);

        var result = VFloat.MulAdd(a, b, c);
    ...
    {
        var x = Range(-8f, 2.3f, VFloat.LaneCount);
    ...
    public void Atan2_AllQuadrants_MatchesMathF()
    {
        ...
        {
            var r = VectorMath.Atan2(new VFloat(y), new VFloat(x));
    ...
    {
        var r = VectorMath.Atan2(VFloat.Zero, VFloat.Zero);
    ...
    {
        var x = Range(-0.95f, 0.27f, VFloat.LaneCount);
    ...
    {
        var x = Range(-27f, 9.5f, VFloat.LaneCount);
    ...
    {
        var x = Range(-3f, 1.7f, VFloat.LaneCount);
        var y = Range(4f, -0.9f, VFloat.LaneCount);
    ...
    private static VFloat BuildExpected(Func<float, float> fn, VFloat input)
    {
        ...
        for (int l = 0; l < w; l++) data[l] = fn(input.GetLane(l));
        return VFloat.Load(data, 0);
    }
}
