...
public class VectorMathDoubleTests
{
    ...
    {
        double[] data = new double[VDouble.LaneCount];
        for (int l = 0; l < VDouble.LaneCount; l++)
            data[l] = f(x.GetLane(l));
        return VDouble.Load(data, 0);
    }
    ...
    {
        VDouble x = Range(0.5, 1.5, VDouble.LaneCount);
    ...
    {
        VDouble a = Range(1.1, 0.7, VDouble.LaneCount);
        VDouble b = Range(-2.3, 0.9, VDouble.LaneCount);
        VDouble c = Range(0.5, -0.4, VDouble.LaneCount);
        VDouble r = VDouble.MulAdd(a, b, c);
    ...
    {
        VDouble x = Range(-3.7, 0.9, VDouble.LaneCount);
    ...
    {
        VDouble x = Range(-2.5, 1.25, VDouble.LaneCount);
    ...
    {
        VDouble x = Range(-2.0, 1.0, VDouble.LaneCount);
        VDouble clamped = VectorMath.Clamp(x, new VDouble(-1d), new VDouble(1d));
        for (int l = 0; l < VDouble.LaneCount; l++)
            Assert.Equal(Math.Clamp(x.GetLane(l), -1d, 1d), clamped.GetLane(l));

        VDouble lerped = VectorMath.Lerp(new VDouble(2d), new VDouble(4d), new VDouble(0.25));
        for (int l = 0; l < VDouble.LaneCount; l++)
    ...
    {
        VDouble x = Range(-5.0, 1.3, VDouble.LaneCount);
    ...
    {
        VDouble x = Range(-700.0, 175.0, VDouble.LaneCount);
        AssertApprox(VectorMath.Exp(x), Map(x, Math.Exp), Tolerance);
    }
    ...
    {
        VDouble r = VectorMath.Exp(VDouble.Zero);
        for (int l = 0; l < VDouble.LaneCount; l++)
    ...
    {
        VDouble x = Range(0.1, 2.7, VDouble.LaneCount);
    ...
    {
        VDouble x = Range(1e-8, 1e8, VDouble.LaneCount);
        AssertApprox(VectorMath.Log(x), Map(x, Math.Log), Tolerance);
    }
    ...
    {
        VDouble x = Range(0.5, 0.8, VDouble.LaneCount);
    ...
    {
        VDouble x = Range(0.5, 1.1, VDouble.LaneCount);
        VDouble y = new VDouble(2.5);
    ...
    {
        VDouble x = Range(-3.0, 0.9, VDouble.LaneCount);
    ...
    {
        VDouble x = Range(-50.0, 17.7, VDouble.LaneCount);
        AssertApprox(VectorMath.Sin(x), Map(x, Math.Sin), TrigTolerance);
    }
    ...
    {
        VDouble x = Range(-3.0, 1.1, VDouble.LaneCount);
    ...
    public void Tan_MatchesMath()
    {
        ...
        VDouble x = Range(-1.2, 0.4, VDouble.LaneCount);
    ...
    {
        VDouble x = Range(-10.0, 3.3, VDouble.LaneCount);
        VDouble s = VectorMath.Sin(x);
        VDouble c = VectorMath.Cos(x);
        VDouble one = (s * s) + (c * c);
        for (int l = 0; l < VDouble.LaneCount; l++)
        {
    ...
    {
        VDouble x = Range(-4.0, 1.3, VDouble.LaneCount);
    ...
    {
        VDouble r = VectorMath.Tanh(new VDouble(50d));
        for (int l = 0; l < VDouble.LaneCount; l++)
    ...
    {
        VDouble x = Range(-6.0, 1.7, VDouble.LaneCount);
    ...
    {
        VDouble x = Range(0.5, 1.4, VDouble.LaneCount);
    ...
    {
        VDouble x = Range(-8.0, 2.3, VDouble.LaneCount);
    ...
    public void Atan2_AllQuadrants_MatchesMath()
    {
        ...
        foreach ((double y, double x) in cases)
        {
    ...
    {
        VDouble x = Range(-0.95, 0.27, VDouble.LaneCount);
    ...
    {
        VDouble x = Range(-27.0, 9.5, VDouble.LaneCount);
    ...
    {
        VDouble x = Range(-3.0, 1.7, VDouble.LaneCount);
        VDouble y = Range(4.0, -0.9, VDouble.LaneCount);
        VDouble r = VectorMath.Hypot(x, y);
        for (int l = 0; l < VDouble.LaneCount; l++)
        {
