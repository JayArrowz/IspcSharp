...
namespace IspcSharp
{
    ...
    public static class VectorMath
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VFloat Sqrt(VFloat x) => new VFloat(Vector.SquareRoot(x.V));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VFloat Abs(VFloat x) => new VFloat(Vector.Abs(x.V));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VFloat Min(VFloat a, VFloat b) => new VFloat(Vector.Min(a.V, b.V));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VFloat Max(VFloat a, VFloat b) => new VFloat(Vector.Max(a.V, b.V));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VInt Abs(VInt x) => new VInt(Vector.Abs(x.V));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VInt Min(VInt a, VInt b) => new VInt(Vector.Min(a.V, b.V));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VInt Max(VInt a, VInt b) => new VInt(Vector.Max(a.V, b.V));
        ...
        /// <summary>Approximate reciprocal 1/x.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VFloat Rcp(VFloat x) => VFloat.One / x;

        /// <summary>Approximate reciprocal square root 1/sqrt(x).</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VFloat Rsqrt(VFloat x) => VFloat.One / Sqrt(x);

        /// <summary>Per-lane floor. Correct for |x| &lt; 2^31.</summary>
        ...
        /// <summary>Per-lane round-to-nearest (half away from zero). Correct for |x| &lt; 2^31.</summary>
        ...
        /// <summary>Per-lane x^y for x &gt; 0 (uses exp(y*log(x))).</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Per-lane cosine (sin(x + π/2)).</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VFloat Cos(VFloat x) => Sin(x + new VFloat(Pi * 0.5f));

        /// <summary>Per-lane tangent (sin/cos, loses accuracy near odd multiples of π/2).</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VFloat Tan(VFloat x) => Sin(x) / Cos(x);

        /// <summary>Per-lane hyperbolic tangent via exp; clamps input to keep exp in range.</summary>
        ...
        /// <summary>Sigmoid 1/(1+e^-x).</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>Per-lane arcsine for x in [-1, 1] (π/2 − acos, so asin/acos stay complementary).</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VFloat Asin(VFloat x) => new VFloat(Pi * 0.5f) - Acos(x);

        /// <summary>Per-lane arccosine for x in [-1, 1] (via the atan half-angle identity).</summary>
        ...
        /// <summary>Per-lane cube root (handles negatives; exp/log seed + one Newton step).</summary>
        ...
        /// <summary>Per-lane hypot: sqrt(x² + y²) without intermediate overflow.</summary>
        ...
        private static Vector<int> Divide(Vector<int> a, int divisor)
        {
            ...
            for (int l = 0; l < Vector<int>.Count; l++) tmp[l] = a[l] / divisor;
        ...
        private static readonly Vector<long> s_roundMagicBits =
            new Vector<long>(BitConverter.DoubleToInt64Bits(RoundMagicD));
        ...
        /// <summary>Per-lane floor. Correct for |x| &lt; 2^52.</summary>
        ...
        /// <summary>Per-lane truncation toward zero. Correct for |x| &lt; 2^52. This is what
        /// <c>(int)</c>/<c>(long)</c> casts lower to in double [Spmd] kernels.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static VDouble Truncate(VDouble x)
            => new VDouble(Vector.ConvertToDouble(Vector.ConvertToInt64(x.V)));

        /// <summary>Per-lane round-to-nearest (half away from zero). Correct for |x| &lt; 2^52.</summary>
        ...
        public static VDouble Log(VDouble x)
        {
            ...
            var ef = new VDouble(Vector.AsVectorDouble(eAdj + s_roundMagicBits)) - new VDouble(RoundMagicD);
        ...
        /// <summary>Per-lane atan2(y, x) with full quadrant handling. (0, 0) lanes return 0.</summary>
        ...
        /// <summary>Per-lane cube root (handles negatives; exp/log seed + two Newton steps).</summary>
        ...
        private static Vector<long> Divide(Vector<long> a, long divisor)
        {
            ...
            for (int l = 0; l < Vector<long>.Count; l++) tmp[l] = a[l] / divisor;
            return new Vector<long>(tmp);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VDouble2 Sqrt(VDouble2 x) => new VDouble2(Sqrt(x.Lower), Sqrt(x.Upper));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VDouble2 Abs(VDouble2 x) => new VDouble2(Abs(x.Lower), Abs(x.Upper));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VDouble2 Min(VDouble2 a, VDouble2 b) => new VDouble2(Min(a.Lower, b.Lower), Min(a.Upper, b.Upper));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VDouble2 Max(VDouble2 a, VDouble2 b) => new VDouble2(Max(a.Lower, b.Lower), Max(a.Upper, b.Upper));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VDouble2 Rcp(VDouble2 x) => new VDouble2(Rcp(x.Lower), Rcp(x.Upper));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VDouble2 Rsqrt(VDouble2 x) => new VDouble2(Rsqrt(x.Lower), Rsqrt(x.Upper));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VDouble2 Floor(VDouble2 x) => new VDouble2(Floor(x.Lower), Floor(x.Upper));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VDouble2 Round(VDouble2 x) => new VDouble2(Round(x.Lower), Round(x.Upper));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VDouble2 Truncate(VDouble2 x) => new VDouble2(Truncate(x.Lower), Truncate(x.Upper));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VDouble2 Exp(VDouble2 x) => new VDouble2(Exp(x.Lower), Exp(x.Upper));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VDouble2 Log(VDouble2 x) => new VDouble2(Log(x.Lower), Log(x.Upper));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VDouble2 Pow(VDouble2 x, VDouble2 y) => new VDouble2(Pow(x.Lower, y.Lower), Pow(x.Upper, y.Upper));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VDouble2 Sin(VDouble2 x) => new VDouble2(Sin(x.Lower), Sin(x.Upper));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VDouble2 Cos(VDouble2 x) => new VDouble2(Cos(x.Lower), Cos(x.Upper));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VDouble2 Tan(VDouble2 x) => new VDouble2(Tan(x.Lower), Tan(x.Upper));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VDouble2 Tanh(VDouble2 x) => new VDouble2(Tanh(x.Lower), Tanh(x.Upper));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VDouble2 Sigmoid(VDouble2 x) => new VDouble2(Sigmoid(x.Lower), Sigmoid(x.Upper));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VDouble2 Atan(VDouble2 x) => new VDouble2(Atan(x.Lower), Atan(x.Upper));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VDouble2 Atan2(VDouble2 y, VDouble2 x) => new VDouble2(Atan2(y.Lower, x.Lower), Atan2(y.Upper, x.Upper));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VDouble2 Asin(VDouble2 x) => new VDouble2(Asin(x.Lower), Asin(x.Upper));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VDouble2 Acos(VDouble2 x) => new VDouble2(Acos(x.Lower), Acos(x.Upper));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VDouble2 Cbrt(VDouble2 x) => new VDouble2(Cbrt(x.Lower), Cbrt(x.Upper));
        [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VDouble2 Hypot(VDouble2 x, VDouble2 y) => new VDouble2(Hypot(x.Lower, y.Lower), Hypot(x.Upper, y.Upper));
