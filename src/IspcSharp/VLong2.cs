...
public readonly struct VLong2 : IEquatable<VLong2>
{
    ...
    /// <summary>
    /// Lane count, matches <see cref="VInt.LaneCount"/> (twice a VLong gang).
    /// </summary>
    public static int LaneCount => Vector<int>.Count;

    public static VLong2 Zero => new(VLong.Zero, VLong.Zero);
    public static VLong2 One => new(VLong.One, VLong.One);
    ...
    /// <summary>
    /// Widen a full int gang to 64 bits (exact).
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>
    /// Widen a full float gang to 64-bit integers, truncating toward zero.
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>
    /// Narrow back to an int gang (wraps, like a <c>(int)</c> cast).
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public VInt ToInt() => new(Vector.Narrow(Lower.V, Upper.V));

    /// <summary>
    /// Convert to a float gang (rounds to nearest, like a <c>(float)</c> cast).
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public VFloat ToFloat()
        => new(Vector.Narrow(Vector.ConvertToDouble(Lower.V), Vector.ConvertToDouble(Upper.V)));

    /// <summary>
    /// Widen to double precision (exact for |value| &lt; 2^53).
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public VDouble2 ToDouble2() => new(Lower.ToDouble(), Upper.ToDouble());

    public long GetLane(int lane)
        => lane < VLong.LaneCount ? Lower.GetLane(lane) : Upper.GetLane(lane - VLong.LaneCount);

    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VLong2 operator +(VLong2 a, VLong2 b) => new(a.Lower + b.Lower, a.Upper + b.Upper);
    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VLong2 operator -(VLong2 a, VLong2 b) => new(a.Lower - b.Lower, a.Upper - b.Upper);
    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VLong2 operator *(VLong2 a, VLong2 b) => new(a.Lower * b.Lower, a.Upper * b.Upper);
    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VLong2 operator -(VLong2 a) => new(-a.Lower, -a.Upper);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VLong2 operator ^(VLong2 a, VLong2 b) => new(a.Lower ^ b.Lower, a.Upper ^ b.Upper);
    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VLong2 operator ~(VLong2 a) => new(~a.Lower, ~a.Upper);
    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VLong2 operator <<(VLong2 a, int count) => new(a.Lower << count, a.Upper << count);
    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VLong2 operator >>(VLong2 a, int count) => new(a.Lower >> count, a.Upper >> count);
    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VLong2 ShiftRightLogical(VLong2 a, int count) => new(VLong.ShiftRightLogical(a.Lower, count), VLong.ShiftRightLogical(a.Upper, count));
    public static VLong2 operator /(VLong2 a, VLong2 b) => Divide(a, b);
    public static VLong2 operator %(VLong2 a, VLong2 b) => Remainder(a, b);
    public static VLong2 Divide(VLong2 a, VLong2 b) => new(VLong.Divide(a.Lower, b.Lower), VLong.Divide(a.Upper, b.Upper));
    public static VLong2 Remainder(VLong2 a, VLong2 b) => new(VLong.Remainder(a.Lower, b.Lower), VLong.Remainder(a.Upper, b.Upper));

    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VLong2 Min(VLong2 a, VLong2 b) => new(VLong.Min(a.Lower, b.Lower), VLong.Min(a.Upper, b.Upper));
    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VLong2 Max(VLong2 a, VLong2 b) => new(VLong.Max(a.Lower, b.Lower), VLong.Max(a.Upper, b.Upper));
    [MethodImpl(MethodImplOptions.AggressiveInlining)] public static VLong2 Abs(VLong2 a) => new(VLong.Abs(a.Lower), VLong.Abs(a.Upper));

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator VLong2(long uniform) => new(uniform);
    ...
    /// <summary>
    /// Fused multiply-add per half (<c>a*b + c</c>; integer, so no rounding).
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    public static bool operator ==(VLong2 left, VLong2 right)
    {
