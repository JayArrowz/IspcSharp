...
namespace IspcSharp
{
    ...
    {
        /// <summary>result[l] = v[indices[l]], arbitrary lane permutation (ISPC's shuffle).</summary>
        ...
        /// <summary>result[l] = v[(l + offset) mod LaneCount], ISPC's rotate.</summary>
        ...
        /// <summary>All lanes take v[lane], ISPC's broadcast.</summary>
        public static VFloat Broadcast(VFloat v, int lane) => new VFloat(v.V[lane]);

        /// <summary>All lanes take v[lane], ISPC's broadcast.</summary>
        public static VInt Broadcast(VInt v, int lane) => new VInt(v.V[lane]);

        /// <summary>result[l] = v[l + offset], lanes shifted past the edge become 0, ISPC's shift.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        private static VInt RotateIndices(int offset)
        {
            ...
            for (int l = 0; l < w; l++) tmp[l] = (l + normalized) % w;
            return VInt.Load(tmp);
        }
    }
}
